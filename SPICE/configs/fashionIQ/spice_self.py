...
pre_model = "./results/fashionIQ/moco/checkpoint_0499.pth.tar"
embedding = "./results/fashionIQ/embedding/feas_moco_512_l2.npy"
resume = "./results/fashionIQ/{}/checkpoint_last.pth.tar".format(model_name)
